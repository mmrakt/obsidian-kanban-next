  ...
  return function (fp) {
    ...
    return {
      onReady() {
        ...
        if (fp.yearElements) {
          fp.yearElements.forEach((yearElem: HTMLElement) => yearElem.addEventListener('wheel', scroll));
        }
      ...
      onDestroy() {
        ...
        if (fp.yearElements) {
          fp.yearElements.forEach((yearElem: HTMLElement) => yearElem.removeEventListener('wheel', scroll));
        }
